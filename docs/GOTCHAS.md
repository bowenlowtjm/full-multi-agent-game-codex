...
- 2026-06-09 — Unity 6000.4.10f1 batchmode may report `executeMethod class 'AutoRefresher' could not be found` even when scripts compile; fix by retrying plain `-batchmode -quit -projectPath` compile and parsing `Logs/compile.log` for CS errors.
